...
export default function MobileSidebar({ isOpen, onClose }: MobileSidebarProps) {
  return (
    <div 
      className={`fixed inset-y-0 left-0 w-72 bg-white dark:bg-gray-900 shadow-xl z-50 transform ${
        ...
        <nav className="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <div className="px-4 py-2">
            <ul className="space-y-1">
              ...
              <li>
                <Link href="/admin" className="flex items-center px-3 py-2 text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800" onClick={onClose}>
